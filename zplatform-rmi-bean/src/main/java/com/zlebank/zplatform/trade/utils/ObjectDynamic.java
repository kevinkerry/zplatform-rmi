...
public class ObjectDynamic {
     ...
     public static String generateParamer(Object obj,boolean isUpper,String[] unParamstring ) throws Exception{
        ...
        for (Field field : fields) {
            ...
            if(ObjectDynamic.isUnParam(name,unParamstring)){
                continue;
            }
            ...
            if(isUpper){
                 paramers.append(name.toUpperCase());
            }else{
                 paramers.append(name);
            }
            paramers.append("=");
        ...
        if(paramers.toString().endsWith("|")){
            String message=paramers.toString().substring(0, paramers.length()-1);
            //log.info("message:"+message);
            return message;
        }   
        //log.info("message:"+paramers.toString());
        return paramers.toString();
     }
     
     public static Map<String, String> generateMap(Object obj,boolean isUpper,String[] unParamstring ) throws Exception{
        ...
        for (Field field : fields) {
            ...
            String value = object != null ? object.toString() : "";
            if(isUpper){
                paramers.put(name.toUpperCase(), value) ;
            }else{
                paramers.put(name, value) ;
            }
        }
      
        //log.info("message:"+JSON.toJSONString(paramers));
        return paramers;
     }
     
     
     
     private static boolean isUnParam(String field,String[] unParamstring){
         if(unParamstring!=null){
             for(String str : unParamstring){
                 if(field.equals(str)){
                     return true;
                 }
             }
    ...
    public static String generateZLPayParamer(Object obj,boolean isUpper) throws Exception{
        StringBuffer paramers=new StringBuffer();
    ...
    public static String generateReturnParamer(Object obj,boolean isUpper,String[] unParamstring ) throws Exception{
        StringBuffer paramers=new StringBuffer();
